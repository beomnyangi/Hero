...
public class 대악마_전투 extends Thread {
    ...
    public void run() {
        ...
        동물악마와의 전투
         */
        System.out.println("\n'" + great_demon.name + "(Lv:" + great_demon.lv + ")'가 나타났다. '" + great_demon.name + "(Lv:" + great_demon.lv + ")'가 나를 공격하기 시작했다!!!");
        while (true) {
            ...
            utility.print("                                    '" + great_demon.name + "(Lv:" + great_demon.lv + ")'\n" +
                    "              (체력 : " + great_demon.health + "/100, 공격력 : " + great_demon.attack + "/100, 방어력 : " + great_demon.defense + "/100, 민첩성 : " + Math.round(great_demon.quickness) + "/100)\n" +
            ...
            if (newvalue > 0 && newvalue < 6) {
                switch (newvalue) {
                    case 1:
                        ...
                        if (random == 1) {
                            great_demon.health += -hero.attack();
                            //주인공_칼공격소리 주인공_칼공격소리 = new 주인공_칼공격소리();
                            주인공_칼공격소리.start();
                            지연_1000.delay();
                            System.out.println("'" + great_demon.name + "' 체력 " + -hero.attack);
                            지연_1000.delay();
                        } else if (random == 2) {
                            ...
                            주인공_칼공격소리.start();
                            지연_1000.delay();
                            great_demon.defense(attack_newvalue);
                            //주인공_악마방어소리 주인공_악마방어소리 = new 주인공_악마방어소리();
                            주인공_악마방어소리.start();
                            지연_1000.delay();
                        } else if (random == 3) {
                            ...
                            주인공_칼공격소리.start();
                            지연_1000.delay();
                            great_demon.miss(attack_newvalue);
                            //주인공_악마피하기소리 주인공_악마피하기소리 = new 주인공_악마피하기소리();
                            주인공_악마피하기소리.start();
                            지연_1000.delay();
                        }
                        ...
                        if (random == 1) {
                            hero.health += -great_demon.attack();
                            //일반악마_공격소리 일반악마_공격소리 = new 일반악마_공격소리();
                            일반악마_공격소리.start();
                            지연_1000.delay();
                            System.out.println("'" + hero.name + "' 체력 " + -great_demon.attack);
                            지연_1000.delay();
                        } else if (random == 2) {
                            //return;
                        }
                        break;
                    case 2:
                        attack_newvalue = great_demon.attack();
                        //일반악마_공격소리 일반악마_공격소리 = new 일반악마_공격소리();
                        일반악마_공격소리.start();
                        지연_1000.delay();
